...
def initialize_standard_scaler(app):
    app.state.standard_scaler = {
        ...
        "prospective_ref_sc": load("./models/prospectiveReference/prospective_logistic_regression_mean_diff_sc.joblib") ##load("./models/retrospective/prospective_logistic_regression_mean_diff_sc.joblib")
    }
