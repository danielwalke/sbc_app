...
class DetailsPredictionGraph:
    ...
    def __init__(self, graph_cbc_items, model, explainer, threshold, standard_scaler = None, ref_node = None):
    ...
    def get_prospective_output(self):
        ...
        prediction = GraphPredictionDetails(self.graph_cbc_items, self.model, self.threshold, self.explainer, self.standard_scaler, self.ref_node)
